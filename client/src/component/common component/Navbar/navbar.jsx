...
import search from "../../../assets/Navbar assets/search.svg"
...
function NavBar() {
  ...
  const { currentPage, setCurrentPage, setIsLogin, section, setSection } =
    useContext(Context);
  const [dropDown, setDropDown] = useState(false);

  // updateing Current Path whenever Switch
  useEffect(() => {
        ...
        <div className="absolute top-[111px] right-32 w-[16%] h-[22%] rounded-lg backdrop-blur-md bg-[#99959A] shadow-lg">
          <ul>
            ...
            <li className="flex m-5">
              ...
              <p className="mx-4 text-white">Logout</p>
            </li>
          </ul>
        </div>
      ) : null}
